...
2. Initialize Stoneforge:
   ...
   <Aside type="tip">
     **Want to try Stoneforge without API keys?** Run `sf init --demo` to enable [demo mode](/guides/demo-mode/), which uses a free model (opencode/minimax-m2.5-free) for all agents.
   </Aside>
</Steps>
